...
分別來自[《DeepFace: Closing the gap to human-level performance in face verification》(2014)](#Refernce)與《FaceNet: A Unified Embedding for Face Recognition and Clustering》(2015)這兩篇paper提出的方法，而外利用OpenCV來擷取Webcam影像並使用其提供的Haar Cascade進行人臉檢測(Face Detection)
